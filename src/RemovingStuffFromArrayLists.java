...
public class RemovingStuffFromArrayLists {
	...
	public static void main(String[] args) {
		...
		for (int a = stuffIFoundInTheYard.size() - 1; a >= 0; a--) {
			if (stuffIFoundInTheYard.get(a) instanceof Dirt) {
				stuffIFoundInTheYard.remove(a);
			}
		}
		...
		for(int a = truth.size() - 1; a >= 0; a--) {
			if(truth.get(a) == '#') {
				truth.remove(a);
			}
		}
		for(Character a: truth) {
			System.out.print(a);
		}
